# LCAI-0018H — Audit global et certification

Ce ticket réalise l'audit final des niveaux CM1, CM2, 6e, 5e, 4e et 3e.

# LCAI-0018H — Audit global et certification de la couverture pédagogique
...
Le ticket **LCAI-0018H** a pour objectif d'industrialiser complètement le niveau **Tous niveaux** afin qu'il bénéficie des mêmes capacités que le niveau 4e validé lors de la série LCAI-0018B.
...
- Couverture complète des matières Tous niveaux
...
- LCAI-0018B validé
- LCAI-0018C validé
- LCAI-0018D à LCAI-0018G validés
...
Toutes les matières présentes dans le curriculum Tous niveaux.
...
Utilisation exclusive des contenus Approved du curriculum Tous niveaux.
...
Le niveau Tous niveaux est totalement industrialisé et exploitable par tous les moteurs Learning Coach AI.
...
Le niveau Tous niveaux dispose d'un catalogue pédagogique complet exploitable immédiatement par l'ensemble des moteurs Learning Coach AI.
